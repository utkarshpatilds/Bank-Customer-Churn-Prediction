...
input_data = {
    'CreditScore': credit_score, 'Geography': geography_map[geography], 'Gender': gender_map[gender],
    ...
    'Satisfaction Score': satisfaction_score, 'Card Type': card_type_map[card_type], 'Point Earned': point_earned
}
